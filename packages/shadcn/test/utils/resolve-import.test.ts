...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/reignlabs/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/reignlabs/Projects/foobar/src/foo/bar")
  ...
  ).toEqual("/Users/reignlabs/Projects/foobar/src/components/foo/bar/baz")
  ...
  ).toEqual("/Users/reignlabs/Projects/foobar/src/app/components/foo/bar")
  ...
  ).toEqual("/Users/reignlabs/Projects/foobar/lib/utils")
})
