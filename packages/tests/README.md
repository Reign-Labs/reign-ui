...
This package contains integration tests that verify the reign-ui CLI works correctly with a local registry. The tests run actual CLI commands against test fixtures to ensure files are created and updated properly.
