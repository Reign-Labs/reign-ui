...
describe("reign-ui search", () => {
  it("should search items from reignlabs registry", async () => {
    ...
    await configureRegistries(fixturePath, {
      "@reignlabs": "http://localhost:9180/r/{name}",
    })
    const output = await npxReignlabs(fixturePath, ["search", "@reignlabs"])
      ...
      expect.arrayContaining([
        {
          ...
          description: "A button component",
          registry: "@reignlabs",
          addCommandArgument: "@reignlabs/button",
        },
        {
          name: "card",
          type: "registry:ui",
          description: "A card component",
          registry: "@reignlabs",
          addCommandArgument: "@reignlabs/card",
        },
        {
          name: "alert-dialog",
          type: "registry:ui",
          ...
          registry: "@reignlabs",
          addCommandArgument: "@reignlabs/alert-dialog",
        },
      ])
    )
  })
  ...
  it("should list items from multiple registries", async () => {
    ...
    expect(registries).toContain("@reignlabs")
  ...
  it("should list from configured registry", async () => {
    ...
    const output = await npxReignlabs(fixturePath, ["search", "@one"])
  ...
  it("should handle non-existent registry gracefully", async () => {
    const fixturePath = await createFixtureTestDirectory("next-app-init")
    const output = await npxReignlabs(fixturePath, ["search", "@unknown"])
  ...
  it("should handle authentication for secured registries", async () => {
    ...
    const output = await npxReignlabs(fixturePath, ["search", "@two"])
  ...
  it("should handle missing environment variables for authenticated registry", async () => {
    ...
    const output = await npxReignlabs(fixturePath, ["search", "@auth"])
  ...
  it("should handle namespace with special characters", async () => {
    const fixturePath = await createFixtureTestDirectory("next-app-init")
    const output = await npxReignlabs(fixturePath, ["search", "@test-123"])
  ...
  it("should handle validation errors", async () => {
    ...
    const output = await npxReignlabs(fixturePath, ["search", "@bad"])
  ...
  it("should handle network timeouts gracefully", async () => {
    ...
    const output = await npxReignlabs(fixturePath, ["search", "@timeout"])
  ...
  it("should handle partial components.json without other required fields", async () => {
    ...
    const output = await npxReignlabs(fixturePath, ["search", "@one", "@two"])
  ...
  it("should handle typos in search (fuzzy matching)", async () => {
    ...
    // Test dialog typo
    const dialogOutput = await npxReignlabs(fixturePath, [
      "search",
      "@reignlabs",
      "--query",
      "dialg",
    ...
    // Test alert typo
    const alertOutput = await npxReignlabs(fixturePath, [
      "search",
      "@reignlabs",
      "--query",
      "alrt",
  ...
  it("should handle case-insensitive search", async () => {
    ...
    const output1 = await npxReignlabs(fixturePath, [
      "search",
      "@reignlabs",
      "--query",
      "BUTTON",
    ])
    const output2 = await npxReignlabs(fixturePath, [
      "search",
      "@reignlabs",
      "--query",
      "button",
    ])
    const output3 = await npxReignlabs(fixturePath, [
      "search",
      "@reignlabs",
      "--query",
      "BuTtOn",
