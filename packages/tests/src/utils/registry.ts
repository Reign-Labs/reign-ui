            ...
            files: [
              {
                ...
                type: "registry:ui",
                content:
                  "export function AlertDialog() { return <div>AlertDialog Component from Registry Reignlabs</div> }",
              },
            ],
          },
          {
            ...
            files: [
              {
                ...
                type: "registry:ui",
                content:
                  "export function Button() { return <div>Button Component from Registry Reignlabs</div> }",
              },
            ],
          },
        ])
