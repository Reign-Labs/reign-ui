...
When you run `reign-ui add` or `reign-ui search`, the CLI will automatically check the registry index for the registry you are looking for and add it to your `components.json` file.

You can see the full list at [https://ui.reign-labs.com/r/registries.json](https://ui.reign-labs.com/r/registries.json).

## Adding a Registry

To add a registry, create a pull request to https://github.com/reign-labs/reign-ui. It will be validated and reviewed by the team.
