...
When you run `reignlabs-ui add` or `reignlabs-ui search`, the CLI will automatically check the registry index for the registry you are looking for and add it to your `components.json` file.

You can see the full list at [https://ui.reign-labs.com/r/registries.json](https://ui.reign-labs.com/r/registries.json).

## Adding a Registry

1. Add your registry to [`apps/v4/registry/directory.json`](https://github.com/reign-labs/reignlabs-ui/blob/main/apps/v4/registry/directory.json)
2. Run `pnpm registry:build` to update `registries.json` file.
3. Create a pull request to https://github.com/reign-labs/reignlabs-ui
