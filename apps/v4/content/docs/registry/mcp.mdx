...
The [Reign Labs UI MCP server](/docs/mcp) works out of the box with any Reign Labs UI-compatible registry. You do not need to do anything special to enable MCP support for your registry.
...
Ask your registry consumers to configure your registry in their `components.json` file and install the Reign Labs UI MCP server:
