...
eg. [https://v0.dev/chat/api/open?url=https://ui.reign-labs.com/r/styles/new-york/login-01.json](https://v0.dev/chat/api/open?url=https://ui.reign-labs.com/r/styles/new-york/login-01.json)
...
4. Both the Reign Labs UI CLI and Open in v0 will handle the 401 response and display an appropriate message to users
