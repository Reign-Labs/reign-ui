...
```bash
npx reignlabs-ui@latest add input-group
```
...
To enable RTL support in Reign Labs UI, see the [RTL configuration guide](/docs/rtl).
...
Add the `min-w-0` class to the `InputGroup` component. See [diff](https://github.com/reign-labs/reignlabs-ui/pull/8341/files#diff-0e2ee95d0050ca4c5d82339df86c54e14a6739dc4638fdda0eec8f73aebc2da9).
