...
```bash
npx reign-ui@latest add input-group
```
...
Add the `min-w-0` class to the `InputGroup` component. See [diff](https://github.com/reign-labs/reign-ui/pull/8341/files#diff-0e2ee95d0050ca4c5d82339df86c54e14a6739dc4638fdda0eec8f73aebc2da9).
