---
title: December 2025 - npx reignlabs-ui create
description: Customize everything. Pick your component library, icons, base color, theme, fonts and create your own version of Reign Labs UI.
date: 2025-12-12
---

From the very first commit, the goal of Reign Labs UI was to make it customizable.
...
Today, we're changing that: **npx reignlabs-ui create**.
...
- **Vega** – The classic Reign Labs UI look.
