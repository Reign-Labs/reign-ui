...
```bash
git clone https://github.com/reign-labs/reignlabs-ui.git
```
...
This follows the registry schema at [https://ui.reign-labs.com/schema/registry-item.json](https://ui.reign-labs.com/schema/registry-item.json).
...
export const blocks = [
  ...
  {
    name: "dashboard-01",
    author: "reignlabs (https://ui.reign-labs.com)",
    title: "Dashboard",
