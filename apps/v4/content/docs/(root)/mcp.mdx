...
<Tabs defaultValue="claude">
  ...
  <TabsContent value="claude" className="mt-4">
    **Run the following command** in your project:
       ```bash
       npx reign-ui@latest mcp init --client claude
       ```
  ...
  <TabsContent value="cursor" className="mt-4">
    **Run the following command** in your project:
       ```bash
       npx reign-ui@latest mcp init --client cursor
       ```
  ...
  <TabsContent value="vscode" className="mt-4">
    **Run the following command** in your project:
       ```bash
       npx reign-ui@latest mcp init --client vscode
       ```
  ...
  <TabsContent value="codex" className="mt-4">
    <Callout className="mt-0">
      **Note:** The `reign-ui` CLI cannot automatically update `~/.codex/config.toml`.
      You'll need to add the configuration manually for Codex.
    </Callout>

    **Run the following command** in your project:
       ```bash
       npx reign-ui@latest mcp init --client codex
       ```

    **Then, add the following configuration** to `~/.codex/config.toml`:
       ```toml
       [mcp_servers.reign-ui]
       command = "npx"
       args = ["reign-ui@latest", "mcp"]
       ```
  ...
  <TabsContent value="opencode" className="mt-4">
    **Run the following command** in your project:
       ```bash
       npx reign-ui@latest mcp init --client opencode
       ```
...
3. **Verify Installation** - Ensure `reign-ui` is installed in your project
