...
description: Discover community registries for Reign Labs UI components and blocks.
---

import { TriangleAlertIcon } from "lucide-react"

These registries are built into the CLI with no additional configuration required. To add a component, run: `npx reignlabs-ui add @<registry>/<component>`.
...
You can use the `reignlabs-ui` CLI to run your own code registry. Running your own registry allows you to distribute your custom components, hooks, pages, config, rules and other files to any project.
