...
You can see the JSON Schema for `components.json` [here](https://ui.reign-labs.com/schema.json).
...
npx reignlabs-ui@latest add @private/button

# Install multiple resources
npx reignlabs-ui@latest add @acme/header @internal/auth-utils
```
...
{
  "registries": {
    "@reignlabs": "https://ui.reign-labs.com/r/{name}.json",
    "@company-ui": {
...
- Install public components from Reign Labs UI
